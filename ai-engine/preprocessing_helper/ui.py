...
class CategoryLabelsRV(RecycleView):
    ...
    def __init__(self, **kwargs):
        ...
        self.data = [{'text': x}
                     for x in ["job posting", "mock data", "news article"]]
...
class ProcessHtml(BoxLayout):
    ...
    def pretty_clean(self):
        if self.html_input.text == "":
            ...
            return
        self.html_output.text = object_builder.pretty_clean(
    ...
    def escape(self):
        if self.html_input.text == "":
            ...
            return
        self.html_output.text = html.escape(
            " ".join(self.html_input.text.split()))
        pyperclip.copy(self.html_output.text)
        pyperclip.paste()
    ...
    def pprint_unescape(self):
        if self.html_input.text == "":
            ...
            return
        self.html_output.text = object_builder.pprint_unescape(
            self.html_input.text)
        # pyperclip.copy(self.html_output.text)
        # pyperclip.paste()
